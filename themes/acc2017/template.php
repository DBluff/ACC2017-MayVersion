 ...
 */
function acc2017_css_alter(&$css) {
  $exclude = array(
 ...
 */
function acc2017_theme_registry_alter(&$registry) {
  global $theme_key;
 ...
 */
function acc2017_discover_files($theme, $type) {
 ...
 */
function acc2017_theme($existing, $type, $theme, $path) {
  return array(
    'search_block_input_wrapper' => array(
      'render element' => 'element',
      'function' => 'acc2017_search_block_input_wrapper',
    ),
...
drupal_add_js('jQuery(document).ready(function(){jQuery("#accordion").accordion({ heightStyle: "content",});});', 'inline');