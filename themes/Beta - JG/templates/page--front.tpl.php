...
<div id="page">
    <div class="header olay">
                ...
                <div class="row aud_menu">
                    ...
                    <div class="searchContainer" id="searchAdj">
                        <form class="searchbox">
                            ...
                            <input type="submit" class="searchbox-submit" value="GO"> <span class="searchbox-icon"><i class="large material-icons">search</i>
                            </span> </form>
                    </div>
                </div>
            </div>
        ...
        <nav class="mobileNav z-depth-0 hide-on-mid-and-up blue" id="mobNav" role="navigation">
            <div class="mobileLogo"> <a class="acc-logo-mobile" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>"><img
            ...
            <div class="hamburger">
                <a href="#" data-activates="slide-out-prim" class="button-collapse"><i
                            class="material-icons large" aria-hidden="true">menu</i></a> </div>
        </nav>
    </div>
    <div class="main">
        <div class="<?php print $classes; ?>" <?php print $attributes; ?>>
            <div class="content" <?php print $content_attributes; ?>>
                <div class="col s12 full"> <img class="responsive-img hero" src="<?php print '/sites/default/files/' . ltrim($homepageContent[115]['field_homepage_hero_image'][LANGUAGE_NONE][0]['uri'], 'public://'); ?> "> </div>
                <div class="row Title">
                    <div class="col m4 s12 offset-m1 title">
                        ...
                        <div class="row nextStep heroNextStep">
                            <div class="col s12 left-align nextStepButtons fixedWidth"> <a class="waves-effect waves-light btn-large btn-flat">APPLY NOW</a> <a class="waves-effect waves-light btn-large btn-flat right">REQUEST INFO</a> </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col s12 bTCol">
                                    <h2 class="band-title blue-text">start here. get there.</h2>
                                    <div class="dividerDiagBlue"></div>
                                </div>
                                <div class="row">
                                    <div class="col s12">
                                        <p class="flow-text"> <strong> It’s not just our motto, it’s the Austin Community College
                                                commitment
                                                to
                                                your
                                                future.
                                            </strong> </p>
                                        <p class="flow-text"> More Central Texans find their path to becoming college graduates and launch or improve their careers at ACC than any other college. We can help you get to your there with the options, resources, and support needed to achieve your dream. </p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col m6 s12 bTCol">
                                    <h2 class="band-title">Areas of Study & Programs</h2> </div>
                                <div class="col m5 s9 fullHeight">
                                    <div class="input-field">
                                        <input type="text" id="autocomplete-input" placeholder="Search Areas of Study & Programs" name="search" class="autocomplete" onkeyup="buttonUp();" required> </div>
                                </div>
                                <div class="col m1 s3 fullHeight">
                                    <a class="waves-effect waves-light btnSearch"> <i class="material-icons">search</i> </a>
                                </div>
                            </div>
                            <div class="row">
                                        ...
                                        <div class="col s12 m12 l6 AoScards">
                                            <div class="valign-wrapper rectangle">
                                                <div class="valign left-align row">
                                                    <p class="flow-text">Explore the possibilities of an ACC education with 100+ programs in 10 areas of study and more, geared for transfer and career training.</p>
                                                    <p><a href="#">Explore All Academic & Career Programs ></a></p>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                        ...
                                        if ($AoSCount === 3 || $AoSCount === 7)
                                            { ?>
                                                <div class="col s12 m6 l3 AoScards cardLeft">
                                                    <div class="z-depth-2 card-panel square hide-on-small-only" style="background-image:url('/sites/default/files/<?php print $AoSparse[0] ?>.jpg');"> </div>
                                                    <div class="AoSoverlay valign-wrapper hide-on-small-only" style="background-color: rgba(<?php print $AoSback[0] ?>,<?php print $AoSback[1] ?>,<?php print $AoSback[2] ?>,0.7)">
                                                        <div class="valign AoSinitialsHome">
                                                            <h6 class="aos-card white-text"><?php print $AoSHead[0][0]; ?></h6> </div>
                                                    </div>
                                                    <div class="AoSmob valign-wrapper col s12 hide-on-med-and-up" style="background-color:rgb(<?php print $AoSback[0] ?>,<?php print $AoSback[1] ?>,<?php print $AoSback[2] ?>)">
                                                        <h6 class="valign white-text center-align"><?php print $AoSHead[0][0]; ?></h6> </div>
                                                </div>
                                    ...
                                    <div class="AoSlist">
                                        <ul class="collection">
                                            <?php foreach ($AoSrecord as $AoS)
                                                ...
                                                $AoSparse = explode(' ', $AoS);
                                                ?>
                                                    <li class="collection-item" style="text-align: center; background-color: <?php print str_replace('Primary', '', $AoSparse[1]); ?>">
                ...
                <div class="row row-band homeSpotlight">
                    <div class="section">
                        <div class="container" id="spotlightCont">
                            ...
                            <!--                                    <h2 class="band-title white-text">in the spotlight</h2>-->
                            ...
                            <div class="row nav nav-transparent">
                                <div class="col s12 bTCol nav-wrapper">
                                    <h2 class="band-title brand-logo white-text">In the Spotlight</h2>
                                    <ul class="band-title right">
                                        <li><a href="#" class="white-link">Visit the ACC Newsroom ></a></li>
                                    </ul>
                                    <div class="dividerDiagGrey"></div>
                                </div>
                            </div>
                                        ...
                                        <div class="row spotlight">
                                            ...
                                            <div class="col m3 cardHeight">
                                                <div class="card hoverable">
                                                    <div class="card-image waves-effect waves-block waves-light"> <img class="activator" src="<?php print '/sites/default/files/' . ltrim($lightImage[$spotCounter], 'public://'); ?>"> </div>
                                                    <div class="card-content"> <span class="card-title activator grey-text text-darken-4"><?php print $spots ?>
                                                            <i class="material-icons right">more_vert</i></span> </div>
                                                    <div class="card-reveal"> <span class="card-title grey-text text-darken-4"><?php print $lightTitle[$spotCounter] ?>
                                                            <i class="material-icons right">close</i></span>
                                                        <p>
                                                            <?php print $lightBody[$spotCounter] ?>
                                                        </p>
                                            ...
                                            <div class="carousel-item">
                                                <div class="row spotlight">
                                                    <div class="cardHeight">
                                                        <div class="card">
                                                            <div class="card-image"> <img class="activator" src="<?php print '/sites/default/files/' . ltrim($lightImage[$spotCounter], 'public://'); ?>"> </div>
                                                            <div class="card-content"> <span class="card-title activator grey-text text-darken-4"><?php print $spots ?>
                                                                    <i class="material-icons right">more_vert</i></span> </div>
                                                            <div class="card-reveal"> <span class="card-title grey-text text-darken-4"><?php print $lightTitle[$spotCounter] ?>
                                                                    <i class="material-icons right">close</i></span>
                    ...
                    <div class="row Directional">
                        <div id="dirMarker">
                            <div class="col s2" id="leftMarker"><h2><i class="fa fa-angle-left white-text" aria-hidden="true"></i></h2></div>
                            <div class="col s2 offset-s8" id="rightMarker"><h2><i class="fa fa-angle-right white-text" aria-hidden="true"></i></h2></div>
                        </div>
                    </div>
                </div>
                <div id="fast-stats" class="row row-band grey lighten-3 z-depth-3">
                    <div class="section">
                        <div class="container">
                            <div class="row">
                                <div class="col s12 bTCol">
                                    <h2 class="band-title">best choice for central texans</h2>
                                    <div class="dividerDiagGrey"></div>
                                </div>
                            </div>
                            <div class="row bTCol">
                                <div class="col m4 BCcard"> <img class="responsive-img" src="/sites/default/files/fstats-affordable.png"> </div>
                                <div class="col m4 BCcard"> <img class="responsive-img" src="/sites/default/files/fstats-highDemand.png"> </div>
                                <div class="col m4 BCcard"> <img class="responsive-img" src="/sites/default/files/fstats-excellence.png"> </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row events gradientRadBlue white-text z-depth-3" id="events">
                    <div class="section">
                        <div class="container">
                            <div class="row nav nav-transparent">
                                <div class="col s12 bTCol nav-wrapper">
                                    <h2 class="band-title brand-logo white-text">Happening at ACC</h2>
                                    <ul class="band-title right">
                                        <li><a href="#" class="white-link">View all calendars ></a></li>
                                    </ul>
                                    <div class="dividerDiagGrey"></div>
                                </div>
                            </div>
                                                ...
                                                <div class="row eventUnit">
                                                    <div class="col s12 m3">
                                                        <div class="calendarIcon blue card xsCard">
                                                            <div class="card-content white blue-text"> <span class="card-title eMonth"><?php print strtoupper($month) ?></span>
                                                    ...
                                                    <div class="col s12 m8">
                                                        <p class="eventTitle">
                                                            <?php print $happenings ?>
                                                        </p>
                                                        <p class="eventDetail">
                                                            <?php print $hapBody[$eventCounter] ?>
                                                        </p> <a href="<?php print $hapLink[$eventCounter] ?>" class="eventDetailLink white-link">View Event ></a> </div>
                                                </div>
                                            </div>
                                            <?php
                                            $eventCounter++;
                                                ...
                                                <li class="collection-item gradientRadBlue white-text">
                                                    <div class="row eventUnit">
                                                        ...
                                                        <div class="col s8 offset-s1">
                                                            ...
                                                            <p class="eventDetail hide-on-med-and-down">
                                                                <?php print $hapBody[$eventCounter] ?>
                                                            </p> <a href="<?php print $hapLink[$eventCounter] ?>" class="eventDetailLink white-link">View Event ></a> </div>
                                                    </div>
                                                </li>
                ...
                <div class="row row-band homeStay noSideMargin z-depth-2 grey lighten-3">
                    <div class="section">
                        <div class="container">
                            <div class="row nav nav-transparent">
                                <div class="col s12 bTCol nav-wrapper">
                                    <h2 class="band-title brand-logo">Stay Connected</h2>
                                    <ul class="right smicons">
                                        <li><i class="fa fa-facebook fa-2x grey-text"></i></li>
                                        <li><i class="fa fa-twitter fa-2x grey-text"></i></li>
                                        <li><i class="fa fa-instagram fa-2x grey-text"></i></li>
                                        <li><i class="fa fa-youtube-play fa-2x grey-text"></i></li>
                                        <li><i class="fa fa-flickr fa-2x grey-text"></i></li>
                                        <li><i class="fa fa-linkedin fa-2x grey-text"></i> </ul>
                                    <div class="dividerDiagGrey"></div>
                                </div>
                            </div>
                            <div class="row noBottomMargin">
                                <div class="row noBottomMargin socialMasonry">
                                    ...
                                    <div class="col m4 s12 mason">
                                        <div class="col s12 mason">
                                            <a href="#modal0">
                                                <div class="col m6 mason" id="fullHeight2"> <img class="masonImg" src="<?php print $imgurl[0] ?>">
                                                    <div class="smIconsAbs"><i class="fa fa-instagram"></i> </div>
                                                </div>
                                            </a>
                                            <a href="#modal1">
                                                <div class="col m6 mason" id="fullHeight3"> <img class="masonImg" src="<?php print $imgurl[1] ?>">
                                                    <div class="smIconsAbs"><i class="fa fa-instagram"></i> </div>
                                                </div>
                                            </a>
                                            <a href="#modal2">
                                    ...
                                    <div class="col m4 s12 mason">
                                        ...
                                        <a href="#modal4">
                                            <div class="col m6 mason" id="fullHeight4"> <img class="masonImg" src="<?php print $imgurl[2] ?>">
                                                <div class="smIconsAbs"><i class="fa fa-instagram"></i></div>
                                            </div>
                                        </a>
                                        <a href="#modal5">
                                            <div class="col m6 mason" id="fullHeight5"> <img class="masonImg" src="<?php print $imgurl[3] ?>">
                                                <div class="smIconsAbs"><i class="fa fa-instagram"></i></div>
                                            </div>
                                        </a>
                                    </div>
                    ...
                    <div class="container">
                        <div class="row nextStep">
                            <div class="col s12 center-align nextStepPrompt white-text">
                                <div class="row">
                                    <h4>GET STARTED</h4> </div>
                            </div>
                            <div class="col s12 center-align nextStepButtons">
                                <div class="row"> <a class="waves-effect waves-light btn-large btn-reverse">APPLY NOW</a> <a class="waves-effect waves-light btn-large btn-reverse">REQUEST INFO</a> </div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-wide">
                <div class="row white-text">
                    <div class="col m3 s12">
                        <div id="acc-logo-foot"> <a class="acc-logo-foot" href="<?php print $front_page; ?>" title="<?php print t('Home'); ?>">
                                <img class="responsive-img" src="/sites/all/themes/acc2017/img/logo.png"
                                     alt="<?php print t('Home'); ?>"/>
                            </a> </div>
                        <div class="col s12 center-align smiconsInv"> <a href="#"><i class="fa fa-facebook fa-2x white-text"></i></a>
                            <a href="#"> <i class="fa fa-twitter fa-2x white-text"></i></a> <a href="#"><i class="fa fa-linkedin fa-2x white-text"></i></a> <a href="#"><i class="fa fa-flickr fa-2x white-text"></i></a> <a href="#"><i class="fa fa-instagram fa-2x white-text"></i></a> <a href="#"><i class="fa fa-youtube-play fa-2x white-text"></i></a> </div>
                    </div>
                    <br>
                    <br>
                    <div class="col m3 s12">
                    ...
                    <div class="col m3 s12">
                        ...
                        <div class="footMenuAddress footMenu"> Austin Community College District
                            <br> 5930 Middle Fiskville Rd
                            <br/> Austin, Texas 78752
                            <br/>512-223-4ACC (4222) </div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <nav class="z-depth-0 audID2 blue" id="navFoot" role="navigation">
        ...
        <div id="topPage">
            <div class="fixed-action-btn"> <a class="btn-floating btn-large waves-effect waves-light z-depth-2" onclick="topFunction()"><i class="fa fa-chevron-up" aria-hidden="true"></i></a></div>
        </div>
        <div class="hide-on-mid-and-up mobAudIcon"><a href="#" data-activates="slide-out-footAud" class="button-collapse"><i
                        class="material-icons large">person</i></a> </div>
        <div class="hide-on-mid-and-up footButL"> <a class="waves-effect waves-light">APPLY NOW</a> </div>
        <div class="hide-on-mid-and-up footButR"> <a class="waves-effect waves-light">REQUEST INFO</a> </div>
        <div class="searchContainer" id="searchFoot">
            <form class="searchbox-foot">
                <input type="search" placeholder="Search ACC" name="search" class="searchbox-input-foot" onkeyup="buttonUp();" required>
                <input type="submit" class="searchbox-submit" value="GO"> <span class="searchbox-icon-foot"><i class="large material-icons">search</i></span> </form>
        </div>
    </nav>
</div>