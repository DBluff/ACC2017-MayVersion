      ...
      <div class="content"<?php print $content_attributes; ?>>
        <div class="col s12">
          <img class="responsive-img hero"
               src="/sites/default/files/LSHero.jpg">
        </div>
          <div class="container"></div> <div class="row right"> <a class="waves-effect waves-light btn-large">APPLY NOW</a> <a class="waves-effect waves-light btn-large">REQUEST INFO</a> </div></div>
